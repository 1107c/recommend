...
class Img2Vec:
    ...
    def __init__(self, model_name, weights="DEFAULT"):
        ...
        self.embed_dict = {
            ...
            "efficientnet_b3": self.obtain_classifier,
        }
    ...
    def assign_transform(self, weights):
        weights_dict = {
            ...
            "efficientnet_b3": 'C:/Users/labadmin/Desktop/annoy/train/best.pt',
        }
    ...
    def embed_dataset(self, source):
        ...
        # 저장
        self.save_data('C:/Users/labadmin/Desktop/annoy/dataset.pkl')
    ...
    def similar_images(self, target_file, n=None):
        dataset= self.load_data('C:/Users/labadmin/Desktop/annoy/dataset.pkl')
        # print(dataset)
